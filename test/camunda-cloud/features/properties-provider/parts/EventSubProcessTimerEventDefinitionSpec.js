...
import diagramXML from './EventSubProcessTimerEventDefinitionSpec.bpmn';


describe('camunda-cloud/features/properties-provider - event-sub-process-timer-start', function() {
