...
import Viewer from 'lib/camunda-cloud/Viewer';

import simpleXml from 'test/fixtures/simple.bpmn';

var singleStart = window.__env__ && window.__env__.SINGLE_START === 'camunda-cloud-viewer';
...
describe('<CamundaCloudViewer>', function() {
