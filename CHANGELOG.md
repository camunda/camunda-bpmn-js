...
* `FEAT`: expose resource metadata on external-resource popup entries
...
* `DEPS`: update to `diagram-js-minimap@5.4.1`
...
* `FEAT`: expose per-writer value `variants` on merged variables ([bpmn-io/variable-resolver#123](https://github.com/bpmn-io/variable-resolver/pull/123))
* `FEAT`: recognize additional Camunda built-ins ([bpmn-io/variable-resolver#121](https://github.com/bpmn-io/variable-resolver/pull/121))
* `FEAT`: improved accuracy of expression analysis ([bpmn-io/variable-resolver#121](https://github.com/bpmn-io/variable-resolver/pull/121))
...
* `FEAT`: resolve `zeebe:adHoc#outputCollection` ([bpmn-io/variable-resolver#69](https://github.com/bpmn-io/variable-resolver/pull/69))
* `FIX`: do not unlink templates with Variable Events for boundary events ([bpmn-io/bpmn-js-element-templates#222](https://github.com/bpmn-io/bpmn-js-element-templates/pull/222))
* `FIX`: do not clear Variable Events on boundary events ([camunda/camunda-bpmn-js-behaviors#120](https://github.com/camunda/camunda-bpmn-js-behaviors/pull/120))
...
* `DEPS`: update to `bpmn-js-copy-as-image@0.4.0`
...
* `FIX`: correctly handle falsy variable `atomicValue` in editor intelligence ([bpmn-io/variable-resolver#68](https://github.com/bpmn-io/variable-resolver/pull/68))
